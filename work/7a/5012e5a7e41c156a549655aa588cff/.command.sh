...
mkdir inputfiles
cp GCA_963565485_1.fasta inputfiles/"1_GCA_963565485_1.fasta"
...
for file in inputfiles/*; do
  ...
  if verify_minimum_file_size "${file}" 'Input' "1k"; then
    echo -e "$(basename ${file%%.*})	Input File	PASS"         >> "1_GCA_963565485_1.Initial_Input_File.tsv"
  else
    echo -e "$(basename ${file%%.*})	Input File	FAIL"         >> "1_GCA_963565485_1.Initial_Input_File.tsv"
    rm ${file}
  fi
done
